...
public class TextDisplay extends BasePresentation {
    ...
    public void update(String tip, final int state) {
        ...
        switch (state) {
            case 0:
                ...
                root.setBackgroundResource(R.mipmap.present_bg_text1);
                ivTitle.setImageResource(R.mipmap.present_pay_iv1);
            ...
            case 1:
                ...
                root.setBackgroundResource(R.mipmap.present_bg_text2);
            ...
            case 2:
                ...
                root.setBackgroundResource(R.mipmap.present_bg_text3);
                ivTitle.setImageResource(R.mipmap.present_pay_iv3);
            ...
            case 4:
                ...
                root.setBackgroundResource(R.mipmap.present_bg_text4);
                ivTitle.setImageResource(R.mipmap.present_pay_iv4);
                break;
        }
    ...
    public void show() {
        super.show();
        int payMode = (int) SharePreferenceUtil.getParam(getContext(), Constants.PAY_MODE_KEY, 7);
        switch (payMode) {
            case Constants.PAY_FACE:
                ...
                break;
            case Constants.PAY_CODE |Constants.PAY_FACE:
                paymodeOne.setVisibility(View.GONE);
            ...
            case Constants.PAY_FACE | Constants.PAY_CODE | Constants.PAY_CASH:
